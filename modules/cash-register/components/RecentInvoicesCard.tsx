...
export default function RecentInvoicesCard() {
  ...
  // Obtener el perfil del cajero actual para mostrarlo como usuario emisor
  ...
  const openModal = (type: "NC", invoiceId: string) => {
    setModalState({
      isOpen: true,
      type,
      invoiceId,
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-100 animate-in fade-in zoom-in-95 duration-150">
            <h4 className="text-base font-black text-slate-800 flex items-center gap-2">
              <span className="w-1.5 h-4 rounded-full inline-block bg-amber-500"></span>
            ...
            <div className="flex items-center justify-end gap-2 mt-5">
              ...
              <button
                ...
                className="px-5 py-2 text-xs font-black text-white rounded-xl transition-all hover:scale-[1.02] active:scale-95 cursor-pointer disabled:opacity-50 disabled:hover:scale-100 bg-amber-500 hover:bg-amber-600"
              >
